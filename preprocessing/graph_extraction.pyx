...
cdef extern from "wrapper_interface.cpp":
    ...
    int compute_graph_edge_feats(string filename,
                                 double* node_feats,
                                 double* adj_mat,
    ...
    int compute_graph_edge_feats3d(string filename,
                                   double** node_feats,
                                   double* adj_mat,
                                   double* edge_feats_mat,
                                   Parameters params)
...
@cython.boundscheck(False)
@cython.wraparound(False)
def get_edge_graph_feats(filename, **kwargs):
    cdef Parameters params
    params.nodes_nb = kwargs.get("nodes_nb")
    params.feat_nb = kwargs.get("feat_nb")
    params.neigh_size = kwargs.get("neigh_size")
    ...
    compute_graph_edge_feats(filename, &node_feats[0, 0], &adj_mat[0, 0], &edge_feats_mat[0, 0, 0], params)
    return node_feats, adj_mat, edge_feats_mat
...
@cython.boundscheck(False)
@cython.wraparound(False)
def get_edge_graph_feats3d(filename, **kwargs):
    cdef Parameters params
    params.nodes_nb = kwargs.get("nodes_nb")
    params.feat_nb = kwargs.get("feat_nb")
    params.neigh_size = kwargs.get("neigh_size")
    ...
    compute_graph_edge_feats3d(filename, node_feats3d_ptr, &adj_mat[0, 0], &edge_feats_mat[0, 0, 0], params)
    return node_feats3d, adj_mat, edge_feats_mat